...
DIR=$1
en_mod=/projdata/alpage2/hmartine/tools/en_lemma_petrov.turbomodel_svm_mira/en_train_lemma_petrov.conll.model
de_mod=/projdata/alpage2/hmartine/tools/de_lemma_petrov.turbomodel_svm_mira/de_train_lemma_petrov.conll.model
fr_mod=/projdata/alpage2/hmartine/tools/fr_lemma_petrov.turbomodel_svm_mira/fr_train_lemma_petrov.conll.model
...
bash parse_target_lemmapetrov.sh $DIR/all.de-en.withids $en_mod #too small
bash parse_target_lemmapetrov.sh $DIR/all.en-fr.withids $fr_mod #too small
bash parse_target_lemmapetrov.sh $DIR/all.en-de.withids $de_mod #too small
